...
var _ protoreflect.List = (*_Service_4_list)(nil)

type _Service_4_list struct {
	list *[]string
}

func (x *_Service_4_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_Service_4_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfString((*x.list)[i])
}

func (x *_Service_4_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	(*x.list)[i] = concreteValue
}

func (x *_Service_4_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	*x.list = append(*x.list, concreteValue)
}

func (x *_Service_4_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message Service at list field RecipientKeys as it is not of Message kind"))
}

func (x *_Service_4_list) Truncate(n int) {
	*x.list = (*x.list)[:n]
}

func (x *_Service_4_list) NewElement() protoreflect.Value {
	v := ""
	return protoreflect.ValueOfString(v)
}

func (x *_Service_4_list) IsValid() bool {
	return x.list != nil
}
...
func (x *_Service_5_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message Service at list field RoutingKeys as it is not of Message kind"))
}
...
func (x *_Service_6_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message Service at list field Accept as it is not of Message kind"))
}
...
var (
	...
	fd_Service_recipient_keys   protoreflect.FieldDescriptor
	fd_Service_routing_keys     protoreflect.FieldDescriptor
	fd_Service_accept           protoreflect.FieldDescriptor
	fd_Service_priority         protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Service_recipient_keys = md_Service.Fields().ByName("recipient_keys")
	fd_Service_routing_keys = md_Service.Fields().ByName("routing_keys")
	fd_Service_accept = md_Service.Fields().ByName("accept")
	fd_Service_priority = md_Service.Fields().ByName("priority")
}
...
func (x *fastReflection_Service) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.RecipientKeys) != 0 {
		value := protoreflect.ValueOfList(&_Service_4_list{list: &x.RecipientKeys})
		if !f(fd_Service_recipient_keys, value) {
			return
		}
	}
	if len(x.RoutingKeys) != 0 {
		value := protoreflect.ValueOfList(&_Service_5_list{list: &x.RoutingKeys})
		if !f(fd_Service_routing_keys, value) {
			return
		}
	}
	if len(x.Accept) != 0 {
		value := protoreflect.ValueOfList(&_Service_6_list{list: &x.Accept})
		if !f(fd_Service_accept, value) {
			return
		}
	}
	if x.Priority != uint32(0) {
		value := protoreflect.ValueOfUint32(x.Priority)
		if !f(fd_Service_priority, value) {
			return
		}
	}
}
...
func (x *fastReflection_Service) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cheqd.did.v2.Service.recipient_keys":
		return len(x.RecipientKeys) != 0
	case "cheqd.did.v2.Service.routing_keys":
		return len(x.RoutingKeys) != 0
	case "cheqd.did.v2.Service.accept":
		return len(x.Accept) != 0
	case "cheqd.did.v2.Service.priority":
...
func (x *fastReflection_Service) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cheqd.did.v2.Service.recipient_keys":
		if len(x.RecipientKeys) == 0 {
			return protoreflect.ValueOfList(&_Service_4_list{})
		}
		listValue := &_Service_4_list{list: &x.RecipientKeys}
		return protoreflect.ValueOfList(listValue)
	case "cheqd.did.v2.Service.routing_keys":
		if len(x.RoutingKeys) == 0 {
			return protoreflect.ValueOfList(&_Service_5_list{})
		}
		listValue := &_Service_5_list{list: &x.RoutingKeys}
		return protoreflect.ValueOfList(listValue)
	case "cheqd.did.v2.Service.accept":
		if len(x.Accept) == 0 {
			return protoreflect.ValueOfList(&_Service_6_list{})
		}
		listValue := &_Service_6_list{list: &x.Accept}
		return protoreflect.ValueOfList(listValue)
	case "cheqd.did.v2.Service.priority":
		value := x.Priority
...
func (x *fastReflection_Service) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cheqd.did.v2.Service.recipient_keys":
		lv := value.List()
		clv := lv.(*_Service_4_list)
		x.RecipientKeys = *clv.list
	case "cheqd.did.v2.Service.routing_keys":
		lv := value.List()
		clv := lv.(*_Service_5_list)
		x.RoutingKeys = *clv.list
	case "cheqd.did.v2.Service.accept":
		lv := value.List()
...
func (x *fastReflection_Service) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cheqd.did.v2.Service.service_endpoint":
		...
		return protoreflect.ValueOfList(value)
	case "cheqd.did.v2.Service.recipient_keys":
		if x.RecipientKeys == nil {
			x.RecipientKeys = []string{}
		}
		value := &_Service_4_list{list: &x.RecipientKeys}
		return protoreflect.ValueOfList(value)
	case "cheqd.did.v2.Service.routing_keys":
		if x.RoutingKeys == nil {
			x.RoutingKeys = []string{}
		}
		value := &_Service_5_list{list: &x.RoutingKeys}
		return protoreflect.ValueOfList(value)
	case "cheqd.did.v2.Service.accept":
		if x.Accept == nil {
			x.Accept = []string{}
		}
		value := &_Service_6_list{list: &x.Accept}
		return protoreflect.ValueOfList(value)
	case "cheqd.did.v2.Service.id":
	...
	case "cheqd.did.v2.Service.priority":
		panic(fmt.Errorf("field priority of message cheqd.did.v2.Service is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cheqd.did.v2.Service"))
		}
...
func (x *fastReflection_Service) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cheqd.did.v2.Service.recipient_keys":
		list := []string{}
		return protoreflect.ValueOfList(&_Service_4_list{list: &list})
	case "cheqd.did.v2.Service.routing_keys":
		list := []string{}
...
func (x *fastReflection_Service) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if len(x.RecipientKeys) > 0 {
			for _, s := range x.RecipientKeys {
				l = len(s)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
		if len(x.RoutingKeys) > 0 {
			for _, s := range x.RoutingKeys {
				l = len(s)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
		if len(x.Accept) > 0 {
			for _, s := range x.Accept {
				l = len(s)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.Accept) > 0 {
			for iNdEx := len(x.Accept) - 1; iNdEx >= 0; iNdEx-- {
				i -= len(x.Accept[iNdEx])
				copy(dAtA[i:], x.Accept[iNdEx])
				i = runtime.EncodeVarint(dAtA, i, uint64(len(x.Accept[iNdEx])))
				i--
				dAtA[i] = 0x32
			}
		}
		if len(x.RoutingKeys) > 0 {
			for iNdEx := len(x.RoutingKeys) - 1; iNdEx >= 0; iNdEx-- {
				i -= len(x.RoutingKeys[iNdEx])
				copy(dAtA[i:], x.RoutingKeys[iNdEx])
				i = runtime.EncodeVarint(dAtA, i, uint64(len(x.RoutingKeys[iNdEx])))
				i--
				dAtA[i] = 0x2a
			}
		}
		if len(x.RecipientKeys) > 0 {
			for iNdEx := len(x.RecipientKeys) - 1; iNdEx >= 0; iNdEx-- {
				i -= len(x.RecipientKeys[iNdEx])
				copy(dAtA[i:], x.RecipientKeys[iNdEx])
				i = runtime.EncodeVarint(dAtA, i, uint64(len(x.RecipientKeys[iNdEx])))
				i--
				dAtA[i] = 0x22
			}
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 4:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field RecipientKeys", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.RecipientKeys = append(x.RecipientKeys, string(dAtA[iNdEx:postIndex]))
				iNdEx = postIndex
			case 5:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field RoutingKeys", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.RoutingKeys = append(x.RoutingKeys, string(dAtA[iNdEx:postIndex]))
				iNdEx = postIndex
			case 6:
				if wireType != 2 {
				...
				x.Accept = append(x.Accept, string(dAtA[iNdEx:postIndex]))
				iNdEx = postIndex
			case 7:
				if wireType != 0 {
...
type Service struct {
	...
	RecipientKeys []string `protobuf:"bytes,4,rep,name=recipient_keys,json=recipientKeys,proto3" json:"recipient_keys,omitempty"`
	...
	Accept []string `protobuf:"bytes,6,rep,name=accept,proto3" json:"accept,omitempty"`
...
var file_cheqd_did_v2_diddoc_proto_rawDesc = []byte{
	...
	,
	...
	0xdf, 0x1f, 0x01, 0x52, 0x07, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x12, 0x3e, 0x0a, 0x07,
	...
	0xdf, 0x1f, 0x01, 0x52, 0x07, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x12, 0x20, 0x0a, 0x0b,
	0x64, 0x65, 0x61, 0x63, 0x74, 0x69, 0x76, 0x61, 0x74, 0x65, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x0b, 0x64, 0x65, 0x61, 0x63, 0x74, 0x69, 0x76, 0x61, 0x74, 0x65, 0x64, 0x12, 0x1d,
	...
	,
