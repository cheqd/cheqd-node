...
_Participants_ are users that have the right to vote on proposals. In the cheqd Network, participants are **bonded** cheq holders. Bonding means something different for Validators and for everyday Users:
