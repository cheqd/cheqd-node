...
Details on how identity transactions are defined is available in [ADR 002: Identity entities and transactions](https://github.com/cheqd/cheqd-node/blob/link-fixing/architecture/adr-list/adr-002-cheqd-did-method.md).
