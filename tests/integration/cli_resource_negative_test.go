...
var _ = Describe("cheqd cli - negative resource", func() {
	...
	It("cannot create resource with missing cli arguments, sign inputs mismatch", func() {
		...
		_, err = cli.CreateResource(tmpDir, resourcetypes.MsgCreateResourcePayload{
			...
			Version:      resourceVersion,
			ResourceType: resourceType,
		}, signInputs, "", testdata.BASE_ACCOUNT_1, helpers.GenerateFees(resourceFeeParams.Json[0].MaxAmount.String()+resourceFeeParams.Json[0].Denom))
		Expect(err).To(HaveOccurred())
		...
		_, err = cli.CreateResource(tmpDir, resourcetypes.MsgCreateResourcePayload{
			...
			Version:      resourceVersion,
			ResourceType: resourceType,
		}, []didcli.SignInput{}, resourceFile, testdata.BASE_ACCOUNT_1, helpers.GenerateFees(resourceFeeParams.Json[0].MaxAmount.String()+resourceFeeParams.Json[0].Denom))
		Expect(err).To(HaveOccurred())
		...
		_, err = cli.CreateResource(tmpDir, resourcetypes.MsgCreateResourcePayload{
			...
			Version:      resourceVersion,
			ResourceType: resourceType,
		}, signInputs, resourceFile, "", helpers.GenerateFees(resourceFeeParams.Json[0].MaxAmount.String()+resourceFeeParams.Json[0].Denom))
		Expect(err).To(HaveOccurred())
		...
		_, err = cli.CreateResource(tmpDir, resourcetypes.MsgCreateResourcePayload{
			...
			Version:      resourceVersion,
			ResourceType: resourceType,
		}, signInputs2, resourceFile, testdata.BASE_ACCOUNT_1, helpers.GenerateFees(resourceFeeParams.Json[0].MaxAmount.String()+resourceFeeParams.Json[0].Denom))
		Expect(err).To(HaveOccurred())
		...
		}, resourceFile, testdata.BASE_ACCOUNT_1, helpers.GenerateFees(resourceFeeParams.Json[0].MaxAmount.String()+resourceFeeParams.Json[0].Denom))
		Expect(err).To(HaveOccurred())
