...
var _ = Describe("cheqd cli - negative resource", func() {
	...
	BeforeEach(func() {
		...
		resp, err := cli.CreateDidDoc(tmpDir, payload, signInputs, "", testdata.BASE_ACCOUNT_1, helpers.GenerateFees(didFeeParams.CreateDid[0].MaxAmount.String()+didFeeParams.CreateDid[0].Denom))
		Expect(err).To(BeNil())
	...
	It("cannot create resource with missing cli arguments, sign inputs mismatch", func() {
		...
		_, err = cli.CreateResource(tmpDir, resourcetypes.MsgCreateResourcePayload{
			...
			Version:      resourceVersion,
			ResourceType: resourceType,
		}, signInputs, "", testdata.BASE_ACCOUNT_1, helpers.GenerateFees(resourceFeeParams.Json[0].MinAmount.String()+resourceFeeParams.Json[0].Denom))
		Expect(err).To(HaveOccurred())
		...
		_, err = cli.CreateResource(tmpDir, resourcetypes.MsgCreateResourcePayload{
			...
			Version:      resourceVersion,
			ResourceType: resourceType,
		}, []didcli.SignInput{}, resourceFile, testdata.BASE_ACCOUNT_1, helpers.GenerateFees(resourceFeeParams.Json[0].MinAmount.String()+resourceFeeParams.Json[0].Denom))
		Expect(err).To(HaveOccurred())
		...
		_, err = cli.CreateResource(tmpDir, resourcetypes.MsgCreateResourcePayload{
			...
			Version:      resourceVersion,
			ResourceType: resourceType,
		}, signInputs, resourceFile, "", helpers.GenerateFees(resourceFeeParams.Json[0].MinAmount.String()+resourceFeeParams.Json[0].Denom))
		Expect(err).To(HaveOccurred())
		...
		_, err = cli.CreateResource(tmpDir, resourcetypes.MsgCreateResourcePayload{
			...
			Version:      resourceVersion,
			ResourceType: resourceType,
		}, signInputs2, resourceFile, testdata.BASE_ACCOUNT_1, helpers.GenerateFees(resourceFeeParams.Json[0].MinAmount.String()+resourceFeeParams.Json[0].Denom))
		Expect(err).To(HaveOccurred())
		...
		}, resourceFile, testdata.BASE_ACCOUNT_1, helpers.GenerateFees(resourceFeeParams.Json[0].MinAmount.String()+resourceFeeParams.Json[0].Denom))
		Expect(err).To(HaveOccurred())
