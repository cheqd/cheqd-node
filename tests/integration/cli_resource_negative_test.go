...
var _ = Describe("cheqd cli - negative resource", func() {
	...
	BeforeEach(func() {
		...
		Expect(err).To(BeNil())
		resp, err := cli.CreateDidDoc(tmpDir, payload, signInputs, "", testdata.BASE_ACCOUNT_1, helpers.GenerateFees(tax.Amount.String()+tax.Denom))
		Expect(err).To(BeNil())
	...
	It("cannot create resource with missing cli arguments, sign inputs mismatch", func() {
		...
		}, signInputs, resourceFile, testdata.BASE_ACCOUNT_1, helpers.GenerateFees(fee.Amount.String()+fee.Denom))
		...
		_, err = cli.CreateResource(tmpDir, resourcetypes.MsgCreateResourcePayload{
			...
			Version:      resourceVersion,
			ResourceType: resourceType,
		}, signInputs, "", testdata.BASE_ACCOUNT_1, helpers.GenerateFees(fee.Amount.String()+fee.Denom))
		Expect(err).To(HaveOccurred())
		...
		_, err = cli.CreateResource(tmpDir, resourcetypes.MsgCreateResourcePayload{
			...
			Version:      resourceVersion,
			ResourceType: resourceType,
		}, []didcli.SignInput{}, resourceFile, testdata.BASE_ACCOUNT_1, helpers.GenerateFees(fee.Amount.String()+fee.Denom))
		Expect(err).To(HaveOccurred())
		...
		_, err = cli.CreateResource(tmpDir, resourcetypes.MsgCreateResourcePayload{
			...
			Version:      resourceVersion,
			ResourceType: resourceType,
		}, signInputs, resourceFile, "", helpers.GenerateFees(fee.Amount.String()+fee.Denom))
		Expect(err).To(HaveOccurred())
		...
		_, err = cli.CreateResource(tmpDir, resourcetypes.MsgCreateResourcePayload{
			...
			Version:      resourceVersion,
			ResourceType: resourceType,
		}, signInputs2, resourceFile, testdata.BASE_ACCOUNT_1, helpers.GenerateFees(fee.Amount.String()+fee.Denom))
		Expect(err).To(HaveOccurred())
		...
		}, resourceFile, testdata.BASE_ACCOUNT_1, helpers.GenerateFees(fee.Amount.String()+fee.Denom))
		Expect(err).To(HaveOccurred())
