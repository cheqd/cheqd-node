...
sudo docker compose --env-file mainnet-latest.env exec validator-0 bash -c 'cp -r "/home/config" "$HOME/.cheqdnode/"'
sudo docker compose --env-file mainnet-latest.env exec validator-1 bash -c 'cp -r "/home/config" "$HOME/.cheqdnode/"'
sudo docker compose --env-file mainnet-latest.env exec validator-2 bash -c 'cp -r "/home/config" "$HOME/.cheqdnode/"'
sudo docker compose --env-file mainnet-latest.env exec validator-3 bash -c 'cp -r "/home/config" "$HOME/.cheqdnode/"'
