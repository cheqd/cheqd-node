...
* [Setup & Configuration](docs/setup-and-configure/README.md)
  * [Setup a new cheqd node](docs/setup-and-configure/readme.md)
  * [Configure a node as validator](docs/setup-and-configure/configure-new-validator.md)
* [Overview of changes that deb package does](docs/overview-of-changes-that-deb-package-does.md)
...
* [cheqd-node docker image](docker/cheqd-node-docker-image.md)
