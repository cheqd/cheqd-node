...
* [docs](docs/README.md)
  * [Architecture Decision Records \(ADR\)](docs/architecture/README.md)
    * [ADR {ADR-NUMBER}: {TITLE}](docs/architecture/adr-template.md)
    * [ADR 001: payment mechanism for issuing credentials](docs/architecture/adr_001_credential_issuing.md)
