...
# User
osmosisd keys add osmosis-user --keyring-backend=test --home=$HOME/.osmosisd

# Genesis
osmosisd add-genesis-account $(osmosisd keys show osmosis-user -a --keyring-backend=test --home=$HOME/.osmosisd) 1000000000stake,1000000000valtoken --home=$HOME/.osmosisd
osmosisd gentx osmosis-user 500000000stake --keyring-backend=test --home=$HOME/.osmosisd --chain-id=testing
