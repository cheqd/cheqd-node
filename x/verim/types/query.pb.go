...
func init() {
	proto.RegisterType((*QueryGetNymRequest)(nil), "verimid.verimnode.verim.QueryGetNymRequest")
	proto.RegisterType((*QueryGetNymResponse)(nil), "verimid.verimnode.verim.QueryGetNymResponse")
	proto.RegisterType((*QueryAllNymRequest)(nil), "verimid.verimnode.verim.QueryAllNymRequest")
	proto.RegisterType((*QueryAllNymResponse)(nil), "verimid.verimnode.verim.QueryAllNymResponse")
}

func init() { proto.RegisterFile("verim/query.proto", fileDescriptor_c3c5a2775652ca1e) }
...
func (c *queryClient) Nym(ctx context.Context, in *QueryGetNymRequest, opts ...grpc.CallOption) (*QueryGetNymResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/verimid.verimnode.verim.Query/Nym", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) NymAll(ctx context.Context, in *QueryAllNymRequest, opts ...grpc.CallOption) (*QueryAllNymResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/verimid.verimnode.verim.Query/NymAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Nym_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/verimid.verimnode.verim.Query/Nym",
	}
...
func _Query_NymAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/verimid.verimnode.verim.Query/NymAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "verimid.verimnode.verim.Query",
