...
type MsgUpdateDidDocPayload struct {
	...
	AlsoKnownAs          []string              `protobuf:"bytes,10,rep,name=also_known_as,json=alsoKnownAs,proto3" json:"also_known_as,omitempty"`
	Service              []*Service            `protobuf:"bytes,11,rep,name=service,proto3" json:"service,omitempty"`
	PreviousVersionId    string                `protobuf:"bytes,12,opt,name=previous_version_id,json=previousVersionId,proto3" json:"previous_version_id,omitempty"`
...
func (m *MsgUpdateDidDocPayload) GetPreviousVersionId() string {
	if m != nil {
...
type MsgDeactivateDidDocPayload struct {
	...
	PreviousVersionId string `protobuf:"bytes,2,opt,name=previous_version_id,json=previousVersionId,proto3" json:"previous_version_id,omitempty"`
...
func (m *MsgDeactivateDidDocPayload) GetPreviousVersionId() string {
	if m != nil {
		return m.PreviousVersionId
	}
	return ""
...
var fileDescriptor_0e353aae8dd04717 = []byte{
	...
	,
}
