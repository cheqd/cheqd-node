...
func TestCreateDID(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			name:  "Works",
			keys: map[string]KeyPair{
				"did:cheqd:test:1123456qwertyu12#key-1": GenerateKeyPair(),
			},
			signers: []string{"did:cheqd:test:1123456qwertyu12#key-1"},
			msg: &types.MsgCreateDidPayload{
				Id:             "did:cheqd:test:1123456qwertyu12",
				Authentication: []string{"did:cheqd:test:1123456qwertyu12#key-1"},
				VerificationMethod: []*types.VerificationMethod{
					{
						Id:         "did:cheqd:test:1123456qwertyu12#key-1",
						Type:       "Ed25519VerificationKey2020",
						Controller: "did:cheqd:test:1123456qwertyu12",
					},
				},
			},
		},
		{
			...
			keys: map[string]KeyPair{
				"did:cheqd:test:1111KeyAgreement#key-1": GenerateKeyPair(),
				AliceKey1:                           keys[AliceKey1],
			},
			signers: []string{AliceKey1},
			msg: &types.MsgCreateDidPayload{
				Id:           "did:cheqd:test:1111KeyAgreement",
				KeyAgreement: []string{"did:cheqd:test:1111KeyAgreement#key-1"},
				Controller:   []string{AliceDID},
				VerificationMethod: []*types.VerificationMethod{
					{
						Id:         "did:cheqd:test:1111KeyAgreement#key-1",
						Type:       "Ed25519VerificationKey2020",
						Controller: "did:cheqd:test:1111KeyAgreement",
					},
				},
			},
		},
		{
			...
			keys: map[string]KeyPair{
				"did:cheqd:test:1Assert1onMethod#key-1": GenerateKeyPair(),
				AliceKey1:                              keys[AliceKey1],
			},
			signers: []string{AliceKey1},
			msg: &types.MsgCreateDidPayload{
				Id:              "did:cheqd:test:1Assert1onMethod",
				AssertionMethod: []string{"did:cheqd:test:1Assert1onMethod#key-1"},
				Controller:      []string{AliceDID},
				VerificationMethod: []*types.VerificationMethod{
					{
						Id:         "did:cheqd:test:1Assert1onMethod#key-1",
						Type:       "Ed25519VerificationKey2020",
						Controller: "did:cheqd:test:1Assert1onMethod",
					},
				},
			},
		},
		{
			...
			keys: map[string]KeyPair{
				"did:cheqd:test:1111111111111111111CapDe1egat1on#key-1": GenerateKeyPair(),
				AliceKey1: keys[AliceKey1],
			},
			signers: []string{AliceKey1},
			msg: &types.MsgCreateDidPayload{
				Id:                   "did:cheqd:test:1111111111111111111CapDe1egat1on",
				CapabilityDelegation: []string{"did:cheqd:test:1111111111111111111CapDe1egat1on#key-1"},
				Controller:           []string{AliceDID},
				VerificationMethod: []*types.VerificationMethod{
					{
						Id:         "did:cheqd:test:1111111111111111111CapDe1egat1on#key-1",
						Type:       "Ed25519VerificationKey2020",
						Controller: "did:cheqd:test:1111111111111111111CapDe1egat1on",
					},
				},
			},
		},
		{
			...
			keys: map[string]KeyPair{
				"did:cheqd:test:1111111111111111111Cap1nvocat1on#key-1": GenerateKeyPair(),
				AliceKey1: keys[AliceKey1],
			},
			signers: []string{AliceKey1},
			msg: &types.MsgCreateDidPayload{
				Id:                   "did:cheqd:test:1111111111111111111Cap1nvocat1on",
				CapabilityInvocation: []string{"did:cheqd:test:1111111111111111111Cap1nvocat1on#key-1"},
				Controller:           []string{AliceDID},
				VerificationMethod: []*types.VerificationMethod{
					{
						Id:         "did:cheqd:test:1111111111111111111Cap1nvocat1on#key-1",
						Type:       "Ed25519VerificationKey2020",
						Controller: "did:cheqd:test:1111111111111111111Cap1nvocat1on",
					},
				},
			},
		},
		{
			...
			msg: &types.MsgCreateDidPayload{
				Id:         "did:cheqd:test:11111c1ntr111er1",
		...
		},
		{
			...
			keys: map[string]KeyPair{
				"did:cheqd:test:111123456qwertyu#key-1": GenerateKeyPair(),
				"did:cheqd:test:111123456qwertyu#key-2": GenerateKeyPair(),
				"did:cheqd:test:111123456qwertyu#key-3": GenerateKeyPair(),
				"did:cheqd:test:111123456qwertyu#key-4": GenerateKeyPair(),
				"did:cheqd:test:111123456qwertyu#key-5": GenerateKeyPair(),
				AliceKey1:                             keys[AliceKey1],
			...
			signers: []string{
				"did:cheqd:test:111123456qwertyu#key-1",
				"did:cheqd:test:111123456qwertyu#key-5",
				AliceKey1,
				BobKey1,
				BobKey2,
				BobKey3,
			...
			msg: &types.MsgCreateDidPayload{
				Id: "did:cheqd:test:111123456qwertyu",
				Authentication: []string{
					"did:cheqd:test:111123456qwertyu#key-1",
					"did:cheqd:test:111123456qwertyu#key-5",
				},
				Context:              []string{"abc", "de"},
				CapabilityInvocation: []string{"did:cheqd:test:111123456qwertyu#key-2"},
				CapabilityDelegation: []string{"did:cheqd:test:111123456qwertyu#key-3"},
				KeyAgreement:         []string{"did:cheqd:test:111123456qwertyu#key-4"},
				AlsoKnownAs:          []string{"did:cheqd:test:111123456eqweqwe"},
				Service: []*types.Service{
					{
						Id:              "did:cheqd:test:111123456qwertyu#service-1",
						Type:            "DIDCommMessaging",
						ServiceEndpoint: "ServiceEndpoint",
					},
				},
				Controller: []string{"did:cheqd:test:111123456qwertyu", AliceDID, BobDID, CharlieDID},
				VerificationMethod: []*types.VerificationMethod{
					{
						Id:         "did:cheqd:test:111123456qwertyu#key-1",
						Type:       "Ed25519VerificationKey2020",
						Controller: "did:cheqd:test:111123456qwertyu",
					},
					{
						Id:         "did:cheqd:test:111123456qwertyu#key-2",
						Type:       "Ed25519VerificationKey2020",
						Controller: "did:cheqd:test:111123456qwertyu",
					},
					{
						Id:         "did:cheqd:test:111123456qwertyu#key-3",
						Type:       "Ed25519VerificationKey2020",
						Controller: "did:cheqd:test:111123456qwertyu",
					},
					{
						Id:         "did:cheqd:test:111123456qwertyu#key-4",
						Type:       "Ed25519VerificationKey2020",
						Controller: "did:cheqd:test:111123456qwertyu",
					},
					{
						Id:         "did:cheqd:test:111123456qwertyu#key-5",
						Type:       "Ed25519VerificationKey2020",
						Controller: "did:cheqd:test:111123456qwertyu",
					},
				},
		...
		},
		{
			...
			msg: &types.MsgCreateDidPayload{
				Id:         "did:cheqd:test:11111c1ntr111er1",
				Controller: []string{AliceDID, "did:cheqd:test:11111111n1tf1und"},
			},
			signers: []string{AliceKey1},
			keys: map[string]KeyPair{
				AliceKey1: keys[AliceKey1],
			},
			errMsg: "did:cheqd:test:11111111n1tf1und: DID Doc not found",
		},
		{
			valid: false,
		...
		},
		{
			...
			errMsg: fmt.Sprintf("%v: verification method not found: invalid signature detected", BobKey4),
		},
		{
			valid: false,
		...
		},
		{
			...
			msg: &types.MsgCreateDidPayload{
				Id:             "did:cheqd:test:111123456qwertyu",
				Authentication: []string{"did:cheqd:test:111123456qwertyu#key-1"},
				VerificationMethod: []*types.VerificationMethod{
					{
						Id:         "did:cheqd:test:111123456qwertyu#key-1",
						Type:       "Ed25519VerificationKey2020",
			...
			errMsg: "signature did:cheqd:test:111123456qwertyu not found: invalid signature detected",
		},
		{
			valid: false,
			...
			signers: []string{"did:cheqd:test:111123456qwertyu#key-2"},
			keys: map[string]KeyPair{
				"did:cheqd:test:111123456qwertyu#key-2": GenerateKeyPair(),
			},
			errMsg: "did:cheqd:test:111123456qwertyu#key-2: verification method not found: invalid signature detected",
		},
		{
			valid: false,
			...
			msg: &types.MsgCreateDidPayload{
				Id:             "did:cheqd:test:111123456qwertyu",
				Controller:     []string{AliceDID, "did:cheqd:test:111123456qwertyu"},
				Authentication: []string{"did:cheqd:test:111123456qwertyu#key-1"},
				VerificationMethod: []*types.VerificationMethod{
					{
						Id:         "did:cheqd:test:111123456qwertyu#key-1",
			...
			signers: []string{AliceKey1, "did:cheqd:test:111123456qwertyu#key-2"},
			keys: map[string]KeyPair{
				AliceKey1:                             keys[AliceKey1],
				"did:cheqd:test:111123456qwertyu#key-2": GenerateKeyPair(),
			},
		...
		},
		{
			...
			signers: []string{"did:cheqd:test:111123456qwertyu#key-1"},
			msg: &types.MsgCreateDidPayload{
				Id:             "did:cheqd:test:111123456qwertyu",
				Authentication: []string{"did:cheqd:test:111123456qwertyu#key-1"},
				VerificationMethod: []*types.VerificationMethod{
			...
			errMsg: "DID is already used by DIDDoc did:cheqd:test:111123456qwertyu: DID Doc exists",
		},
		{
			valid: false,
			...
			errMsg: "did:cheqd:test:111123456qwertyu#key-1 not belong did:cheqd:test:11111c1ntr111er1 DID Doc: invalid verification method",
		},
		{
			valid: false,
