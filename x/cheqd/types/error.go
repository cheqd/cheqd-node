...
var (
	...
	ErrDIDDocDeactivated          = sdkerrors.Register(ModuleName, 1207, "DID Doc deactivated")
	ErrDIDDocAlreadyDeactivated   = sdkerrors.Register(ModuleName, 1208, "DID Doc already deactivated")
